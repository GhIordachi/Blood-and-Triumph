...
namespace GI
{
    public class MeleeWeaponDamageCollider : DamageCollider
    {
        ...
        protected override void DealDamage(CharacterManager enemy)
        {
            ...
            float finalMagicDamage = magicDamage + magicBuffDamage;
            float finalDamage = 0;
            ...
            if (characterManager.isUsingRightHand)
            {
                if (characterManager.characterCombatManager.currentAttackType == AttackType.light)
                {
                    ...
                    finalDamage += finalMagicDamage * characterManager.characterInventoryManager.rightWeapon.lightAttackDamageModifier;
                }
                else if (characterManager.characterCombatManager.currentAttackType == AttackType.heavy)
                {
                    ...
                    finalDamage += finalMagicDamage * characterManager.characterInventoryManager.rightWeapon.heavyAttackDamageModifier;
                }
            }
            ...
            else if (characterManager.isUsingLeftHand)
            {
                if (characterManager.characterCombatManager.currentAttackType == AttackType.light)
                {
                    ...
                    finalDamage += finalMagicDamage * characterManager.characterInventoryManager.leftWeapon.lightAttackDamageModifier;
                }
                else if (characterManager.characterCombatManager.currentAttackType == AttackType.heavy)
                {
                    ...
                    finalDamage += finalMagicDamage * characterManager.characterInventoryManager.leftWeapon.heavyAttackDamageModifier;
                }
            }
